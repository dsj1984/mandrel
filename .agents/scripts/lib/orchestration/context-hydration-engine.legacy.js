/**
 * context-hydration-engine.legacy.js — one-release compatibility shim (Epic #2648).
 *
 * Frozen copy of the pre-envelope prose hydrator. `hydrateContext` delegates here
 * when `agentSettings.hydration.outputMode === 'prose-legacy'`. Delete this module
 * in the cutover PR that removes the `hydration.outputMode` flag (placeholder:
 * chore/epic-2648-hydration-cutover).
 *
 * @module lib/orchestration/context-hydration-engine.legacy
 */
 ...
 */
export async function legacyHydrate(
  task,
  provider,
  epicBranch,
  taskBranch,
