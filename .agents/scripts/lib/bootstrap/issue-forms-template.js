 ...
 */
export const ISSUE_TEMPLATE_RELATIVE_DIR = '.github/ISSUE_TEMPLATE';
 ...
 * Deterministic so the bootstrap test asserts its exact shape.
 *
 * @returns {string}
 */
export function renderConformanceWorkflow() {
