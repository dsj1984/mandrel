...
| `navigation` | No | `object` | — | Navigability-reachability config consumed by the plan-persist draft reachability gate (Epic #4474 PR6). Opt-in: absent or empty routeGlobs degrades to a silent no-op. |
