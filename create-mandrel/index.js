 ...
 * single job is to install the distributed `mandrel` npm package
 ...
 *        a. `npm install mandrel` against a HARDCODED canonical
 *           package name, then
 *        b. `npx mandrel sync` to copy `node_modules/mandrel/` →
 *           `./.agents/`.
 ...
 */
export const CANONICAL_PACKAGE = 'mandrel';
