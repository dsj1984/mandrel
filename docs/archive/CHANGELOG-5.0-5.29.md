# Changelog Archive — v5.0.0 – v5.29.0

Historical release entries from the early v5 cycle (April 9 – April 26, 2026),
moved out of the main `docs/CHANGELOG.md` to keep the active changelog scoped
to the current month of releases. Active changelog: [`docs/CHANGELOG.md`](../CHANGELOG.md).
