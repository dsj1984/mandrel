 ...
 *     absent, run declines, prints the .agents/docs/upgrade-major.md runbook pointer,
...
describe('runUpdate — major gate without --major', () => {
  ...
  it('prints the .agents/docs/upgrade-major.md runbook pointer and the available version', async () => {
    const seams = makeMajorSeams({ target: '2.0.0' });
    const cap = makeCapture();
