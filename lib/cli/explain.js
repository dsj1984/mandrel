 ...
 * layer the value came from (default / agentrc), and a one-line meaning.
 * Secret-shaped keys report `<redacted>` in place of a value — only their
 * source is shown.
 *
 * Usage:
 ...
 * success, 1 on a resolution failure.
 *
