 ...
 *
 * Renders a bounded region inside `docs/configuration.md` from
 ...
 *                are absent from `docs/configuration.md`, they are inserted
...
const DOC_PATH = path.join(PROJECT_ROOT, 'docs', 'configuration.md');
 ...
 * em dash — the value is documented prose-side in `docs/configuration.md`.
 *
 * @param {unknown} value
 * @returns {string}
 */
