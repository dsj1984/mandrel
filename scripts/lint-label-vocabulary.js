 ...
 * `docs/SDLC.md` and every `*.md` under `.agents/workflows/` use the
 * canonical
 ...
 *
 * Scope:
 *   - Files scanned: `docs/SDLC.md` plus every `*.md` under
 *     `.agents/workflows/`.
 ...
 *
 * Ships as part of `npm run lint` via `scripts/run-lint.js`.
 */
...
const DEFAULT_SCAN_TARGETS = Object.freeze([
  path.join(REPO_ROOT, 'docs', 'SDLC.md'),
